...
{
    public class UpdateDevicesCommandHandler : IRequestHandler<UpdateDeviceCommand, Device>
    {
        private readonly IDeviceRepository _deviceRepository;
        private readonly IMapper _mapper;

        public UpdateDevicesCommandHandler(IDeviceRepository deviceRepository, IMapper mapper)
        {
