...
{
    public class GetDevicesByIdQueryHandler(ILogger<GetDevicesByIdQueryHandler>logger,IDevicesRepository devicesRepository,IMapper mapper) : IRequestHandler<GetDevicesByIdQuery, DeviceDto>
    {
