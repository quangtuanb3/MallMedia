...
{
    public class GetAllContentQueryHandler(ILogger<GetAllContentQueryHandler> logger,IMapper mapper,IContentRepository contentRepository) : IRequestHandler<GetAllContentQuery, PagedResult<ContentDto>>
    {
